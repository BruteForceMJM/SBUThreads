...
public class Course {
    ...
    public Map<Student, Double> getStudentsGrades() throws StudentDoesNotExistsException {
    ...
    public List<Student> getStudents() throws StudentDoesNotExistsException {
        if (studentsData.isEmpty()) {
            throw new StudentDoesNotExistsException();
        }
        return studentsData.stream()
    ...
    public void removeStudent(Student student) throws StudentDoesNotExistsException {
    ...
    public void scoreStudent(Student student, Double score) throws StudentDoesNotExistsException {
    ...
    public void scoreTask(Task task, Student student, Double score) throws Exception {
        ...
        if (!studentsData.contains(studentData)) {
            ...
            throw new TaskDoesNotFoundException();
        }
        var oldStudentData = studentsData.stream()
                .parallel()
                .filter(studentData1 -> studentData1.equals(studentData))
